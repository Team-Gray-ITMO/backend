...
public class JobController {
    ...
    public ResponseEntity<JobDto> createJob(@RequestBody @Validated JobCreateDto data) {
    ...
    public ResponseEntity<JobDto> updateJob(@RequestBody @Validated JobUpdateDto data) {
